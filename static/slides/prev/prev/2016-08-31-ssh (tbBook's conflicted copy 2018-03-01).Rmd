...
```
cr173@gort [~]$ cd Sta523
cr173@gort [Sta523]$ pwd
...
Connect to `gort` and change to `Sta523/filesystem` directory in *my* home directory.

```
cr173@gort [~]$ cd ~cr173/Sta523/filesystem
```
...
```
cr173@gort [~]$ cat ~/Sta523/filesystem/haiku.txt 
...
```
cr173@gort [~]$ head -n 2 ~/Sta523/filesystem/haiku.txt 
All night with no sleep
Caffeine your only partner
```
...
```
cr173@gort [~]$ tail -n 3 ~/Sta523/filesystem/haiku.txt 
Caffeine your only partner
Damn thing still won't work
-chimera
```
...
```
cr173@gort [~]$ cat ~/Sta523/filesystem/haiku.txt | grep ^[AC]
All night with no sleep
Caffeine your only partner
```
...
```
cr173@gort [~]$ head -n 2 ~/Sta523/filesystem/haiku.txt | tail -n 1
Caffeine your only partner
```
...
```
cr173@gort [~]$ tail -n 2 ~/Sta523/filesystem/haiku.txt | head -n 1
Damn thing still won't work
```
...
$ scp cr173@gort.stat.duke.edu:~/Sta523/filesystem/haiku.txt ./
